...
export const backgroundWallpaper: BackgroundWallpaperConfig = {
	...
	src: {
		...
		// 注意：站点是 https，远程地址必须是 https，http 视频会被浏览器的混合内容策略拦掉
		// 托管在 Cloudflare R2（出口流量免费），经 Custom Domain 走 CF 自动签发的证书
		playerUrl: "https://video.yorushika.cyou/mv/C_540p_h265_crf34.mp4",
	},
	// 横幅壁纸和全屏壁纸共享配置
	common: {
